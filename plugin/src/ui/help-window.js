  ...
  const GUIDE = {
    "zh-CN": {
      ...
      advanced: [
        ...
        ["screening.llmMinScore / llmBatchSize / llmRetryBatchSize / llmPasses", "控制正式 LLM 评分最低分、批大小、解析失败小批重试大小和多轮评分。"],
    ...
    "en-US": {
      ...
      advanced: [
        ...
        ["screening.llmMinScore / llmBatchSize / llmRetryBatchSize / llmPasses", "Controls formal LLM scoring threshold, batch size, parse-failure retry batch size, and scoring passes."],
